...
var Slider = function (_Component) {
  ...
  function Slider(props, context) {
    ...
    _this.coordinates = function (pos) {
      ...
      var handlePos = orientation === 'horizontal' && !reverse ? position + grab : reverse ? position - grab : position;
      var fillPos = orientation === 'horizontal' && !reverse ? handlePos : limit - handlePos;
